...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.v3.3.5.css">
    ...
    <body id="body">
	    ...
	    <section id="hero-area">
	        <div class="container">
	            <div class="row">
	                <div class="col-md-6">
	                    <div class="block">
	                        <h1 class="wow fadeInDown">A passionate web company abc</h1>
        ...
        <script src="js/bootstrap.min.v3.3.5.js"></script>
