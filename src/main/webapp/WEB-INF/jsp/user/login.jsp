  ...
  <body class="text-center">
	...
	<div class="row">
		<form class="form-signin" method="POST" action="${contextPath}/login">
		    ...
		    <div class="form-group"> <label for="SignIn"><h2>Sign In</h2></label> </div>
		    <div class="form-group">
				<label for="inputEmail">Username</label> 
				<input name="username" id="username" type="text" class="form-control" value="administrator"	autofocus="true" />	</div>
